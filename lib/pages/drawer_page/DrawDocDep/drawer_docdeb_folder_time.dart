...
class DocDebTimeDetail extends StatefulWidget {
  final String id;
  final Function? onGoBack;
  const DocDebTimeDetail({Key? key, required this.id,this.onGoBack}) : super(key: key);

  @override
  State<DocDebTimeDetail> createState() => _DocDebTimeDetailState();
}


class _DocDebTimeDetailState extends State<DocDebTimeDetail> {
  bool loading = false;
  ...
  Future<Null> getdata() async {
    try{
      ...
      String url = pathurl.fTimeId+widget.id;
