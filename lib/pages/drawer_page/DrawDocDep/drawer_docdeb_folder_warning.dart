...
class DocDebWarningDetail extends StatefulWidget {
  final String id;
  const DocDebWarningDetail({Key? key, required this.id}) : super(key: key);

  @override
  State<DocDebWarningDetail> createState() => _DocDebWarningDetailState();
}

class _DocDebWarningDetailState extends State<DocDebWarningDetail> {
  bool loading = false;
  ...
  Future<Null> getdata() async{
    try{
      String url = pathurl.fWarningId + widget.id;
