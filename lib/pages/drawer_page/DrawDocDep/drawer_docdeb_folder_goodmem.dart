...
class DocDebGoodMemmoryDetail extends StatefulWidget {
  final String id;
  const DocDebGoodMemmoryDetail({Key? key, required this.id}) : super(key: key);

  @override
  State<DocDebGoodMemmoryDetail> createState() => _DocDebGoodMemmoryDetailState();
}

class _DocDebGoodMemmoryDetailState extends State<DocDebGoodMemmoryDetail> {
  bool loading = false;
  ...
  Future<Null> getdata() async{
    try{
      ...
      String url = pathurl.fScoreId+widget.id;
