...
class DocDebLaDetail extends StatefulWidget {
  final String id;
  const DocDebLaDetail({Key? key, required this.id}) : super(key: key);

  @override
  State<DocDebLaDetail> createState() => _DocDebLaDetailState();
}

class _DocDebLaDetailState extends State<DocDebLaDetail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("รายละเอียดเอกสารลางาน"),
        centerTitle: true,
        elevation: 0,
