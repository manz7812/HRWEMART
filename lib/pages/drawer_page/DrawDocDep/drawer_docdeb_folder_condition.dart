...
class DocDebConditionDetail extends StatefulWidget {
  final String id;
  const DocDebConditionDetail({Key? key, required this.id}) : super(key: key);

  @override
  State<DocDebConditionDetail> createState() => _DocDebConditionDetailState();
}

class _DocDebConditionDetailState extends State<DocDebConditionDetail> {
  ...
  Future<Null> getdata() async {
    try{
      String url = pathurl.fConditionId+widget.id;
