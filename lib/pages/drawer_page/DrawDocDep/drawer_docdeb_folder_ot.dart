...
class DocDebOTDetail extends StatefulWidget {
  final String id;
  const DocDebOTDetail({Key? key, required this.id}) : super(key: key);

  @override
  State<DocDebOTDetail> createState() => _DocDebOTDetailState();
}

class _DocDebOTDetailState extends State<DocDebOTDetail> {
  bool loading = false;
  String token = "";
  ...
  Future<Null> getdata() async{
    try{
      String url = pathurl.fOTId + widget.id;
