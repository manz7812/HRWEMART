...
import 'Doc_LA_edit.dart';

class DetailDocLaPage extends StatefulWidget {
  final String id;
  final Function? onGoBack;
  const DetailDocLaPage({Key? key, required this.id,this.onGoBack}) : super(key: key);

  @override
  State<DetailDocLaPage> createState() => _DetailDocLaPageState();
}

class _DetailDocLaPageState extends State<DetailDocLaPage> {
  bool loading = false;
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: TextButton(
                                  ...
                                  onPressed: (){
                                    Navigator.push(context, MaterialPageRoute(builder: (context) =>  EditDocLa(id: widget.id,))).then(onGoBack);
                                  },
                                  child: Text('แก้ไข')),
                            ),
                          ),
