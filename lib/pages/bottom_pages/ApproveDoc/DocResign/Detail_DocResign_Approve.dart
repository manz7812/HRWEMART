...
class DetailApproveDocResign extends StatefulWidget {
  final String id;
  final Function? onGoBack;
  const DetailApproveDocResign({Key? key, required this.id,this.onGoBack}) : super(key: key);

  @override
  State<DetailApproveDocResign> createState() => _DetailApproveDocResignState();
}

class _DetailApproveDocResignState extends State<DetailApproveDocResign> {
  bool loading = false;
    ...
    try{
      ...
      if (response.statusCode == 200) {
        setState(() {
          ...
          var appStatus = dataID[0]['re_approve'];
                            ...
                            Card(
                              child: Container(
                                ...
                                child: ElevatedButton(///อนุมัติ
                                    ...
                                    onPressed: dataID[0]['re_status'] == 'อนุมัติ' ||
                                        dataID[0]['re_status'] == "ไม่อนุมัติ" ||
                                        dataID[0]['re_status'] == "ตีกลับ" ||
                                        dataID[0]['re_status'] == "ยกเลิก" ||
                                        approve == false ? null
                                        : (){
                                      AwesomeDialog(
                                        context: context,
