...
class DetailApproveDocAddTime extends StatefulWidget {
  final String id;
  final Function? onGoBack;
  const DetailApproveDocAddTime({Key? key, required this.id,this.onGoBack}) : super(key: key);

  @override
  State<DetailApproveDocAddTime> createState() => _DetailApproveDocAddTimeState();
}

class _DetailApproveDocAddTimeState extends State<DetailApproveDocAddTime> {
  bool loading = false;
  ...
  Future<Null> getdata() async {
    try{
      ...
      String url = pathurl.getDTHedPonID+widget.id;
      ...
      if (response.statusCode == 200) {
        setState(() {
          ...
          dataID = data['data'];
          dataApprover = data['data'][0]['at_approve'];
          // if(data['data'][0]['at_note'] == ""){
          //   dataNote = [];
          // }else{
          //   dataNote = data['data'][0]['at_note'];
          // }
          var appStatus = dataID[0]['at_approve'];
          ...
          var startDate = dataID[0]['at_date'];
          var createdDate = dataID[0]['at_date_created'];
  ...
  Future<Null> setStatus(id,status,remark) async{
    try{
      var response = await patch(
          Uri.parse(pathurl.updateStatusDocAddtime+id),
          headers: {"Authorization": "Bearer $token"},
          body: {
            "status": "${status}",
            "remark": "${remark}",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("รายละเอียดขอเพิ่มเวลา"),
        centerTitle: true,
        elevation: 0,
            ...
            child: Column(
              children: [
                Card(
                  ...
                  child: Container(
                    width: double.infinity,
                    decoration: dataID[0]['at_status'] == 'ยกเลิก' ? BoxDecoration(
                      ...
                      children: [
                        ...
                        ?Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text("ขอเมื่อวันที่ ${dataID[0]['at_date_created']}",style: TextStyle(fontSize: 16,color: Colors.red),),
                            ],
                          ),
                        )
                        ////ล่วงหน้า////
                        :Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text("ขอเมื่อวันที่ ${dataID[0]['at_date_created']}",style: TextStyle(fontSize: 16,color: Colors.green),),
                            ],
                          ),
                        ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                padding: EdgeInsets.fromLTRB(25, 0, 10, 10),
                                child: Text(
                                  "${dataID[0]['at_time']} (${dataID[0]['at_inout']})",
                                  style: TextStyle(
                                    color: Colors.black,
                                    fontWeight: FontWeight.w400,
                                    fontSize: 16,
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                "${dataID[0]['at_status']}",
                                style: TextStyle(
                                  color: dataID[0]['at_status'] == 'อนุมัติ' ? Colors.green
                                      : dataID[0]['at_status'] == 'ไม่อนุมัติ' || dataID[0]['at_status'] == 'ยกเลิก'? Colors.red
                                      : dataID[0]['at_status'] == 'ตีกลับ' ? Colors.orange
                                      : Colors.black87,
                                  fontWeight: FontWeight.w400,
                                  fontSize: 16,
                                ),
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                "โดย : ${dataID[0]['at_emp']['name'].split(" ")[1]} ${dataID[0]['at_emp']['name'].split(" ")[2]}",
                                style: TextStyle(
                                  color: Colors.deepPurpleAccent,
                                  fontWeight: FontWeight.w600,
                                  fontSize: 16,
                            ...
                            Card(
                              child: Container(
                                ...
                                child: ElevatedButton(///อนุมัติ
                                    ...
                                    onPressed: dataID[0]['at_status'] == 'อนุมัติ' ||
                                        dataID[0]['at_status'] == "ไม่อนุมัติ" ||
                                        dataID[0]['at_status'] == "ตีกลับ" ||
                                        dataID[0]['at_status'] == "ยกเลิก" ||
                                        approve == false ? null
                                        : (){
                                      AwesomeDialog(
                                        context: context,
