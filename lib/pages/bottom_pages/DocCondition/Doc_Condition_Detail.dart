...
import 'Doc_Condition_Edit.dart';

class DetailDocConditionPage extends StatefulWidget {
  final String id;
  const DetailDocConditionPage({Key? key, required this.id}) : super(key: key);

  @override
  State<DetailDocConditionPage> createState() => _DetailDocConditionPageState();
}

class _DetailDocConditionPageState extends State<DetailDocConditionPage> {
  bool loading = false;
                                ...
                                child: TextButton(
                                    ...
                                    onPressed: (){
                                      Navigator.of(context).push(
                                          PageTransition(
                                            child: EditDocConditionPage(id: widget.id,),
