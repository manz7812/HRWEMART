...
import 'Doc_Resign_Detail.dart';


class InsertDocResignPage extends StatefulWidget {
  const InsertDocResignPage({Key? key}) : super(key: key);

  @override
  State<InsertDocResignPage> createState() => _InsertDocResignPageState();
}

class _InsertDocResignPageState extends State<InsertDocResignPage> {
  ...
  Future<Null> getdata() async {
    try{
      ...
      String url = pathurl.getDTResign+"?status=$selectedStatus&year=$selectedYear&month=$selectedMonth";
  ...
  Future<Null> searchdata(year,month,status) async{
    ...
    try{
      ...
      final String url = pathurl.getDTResign+'?status=$status&year=$year&month=$month';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: loading ? LoaderOverlay(
        ...
        child: Column(
          children: [
            ButtonInsert().show_ButtonInsert_DocResign(context,onGoBack),
            Expanded(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        dataDocResign.isEmpty ? Nulldata() :
                        ListView.builder(
                          itemCount: dataDocResign.length,
                          scrollDirection: Axis.vertical,
                          shrinkWrap: true,
                          physics: ScrollPhysics(),
                          itemBuilder: (context , i){
                            return getCard(dataDocResign[i]);
                          },
                        ),
                      ],
                    ),
    ...
    return InkWell(
      onTap: (){
        Navigator.of(context).push(
            PageTransition(
              child: DetailDocResignPage(id: IDdoc),
