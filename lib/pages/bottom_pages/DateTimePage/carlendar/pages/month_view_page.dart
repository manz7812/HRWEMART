...
class MonthViewPageDemo extends StatefulWidget {
  const MonthViewPageDemo({Key? key,}) : super(key: key);
      ...
      child: Scaffold(
        ...
        floatingActionButton: SpeedDial(
          ...
          children: [
            SpeedDialChild(
                backgroundColor: Colors.deepPurpleAccent,
                child: Icon(MaterialCommunityIcons.calendar_today,size: 30,color: Colors.white,),
                label: 'รายวัน',
                labelStyle: TextStyle(fontSize: 16,fontWeight: FontWeight.w700),
                onTap: ()async{
                  await Future.delayed(Duration(seconds: 0), () {
                    context.pushRoute(DayViewPageDemo());
                  });
                }
            ),
            SpeedDialChild(
