...
import 'Doc_OT_Edits.dart';
import 'Doc_OT_edit.dart';

class DetailDocOTPage extends StatefulWidget {
  final  String id;
  const DetailDocOTPage({Key? key, required this.id}) : super(key: key);

  @override
  State<DetailDocOTPage> createState() => _DetailDocOTPageState();
}

class _DetailDocOTPageState extends State<DetailDocOTPage> {
  bool loading = false;
  ...
  Future<Null> getdata() async {
    try{
      ...
      String url = pathurl.getDOTID+widget.id;
  ...
  Future<Null> setStatus(id,status,remark) async{
    try{
      var url = pathurl.setStatusOT+id;
                                ...
                                child: TextButton(
                                    ...
                                    onPressed: (){
                                      Navigator.of(context).push(
                                          PageTransition(
                                            child: EditsDocOTPage(id: widget.id),
