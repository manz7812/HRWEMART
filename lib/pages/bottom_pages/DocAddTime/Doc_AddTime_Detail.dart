...
import 'Doc_AddTime_Edit.dart';

class DetailDocAddTimePage extends StatefulWidget {
  final String id;
  final Function? onGoBack;
  const DetailDocAddTimePage({Key? key, required this.id,this.onGoBack}) : super(key: key);

  @override
  State<DetailDocAddTimePage> createState() => _DetailDocAddTimePageState();
}


class _DetailDocAddTimePageState extends State<DetailDocAddTimePage> {
  bool loading = false;
                          ...
                          Stack(
                            children: <Widget>[
                              ClipRRect(
                                  ...
                                  child: Image.network(dataID[0]['at_img'],fit: BoxFit.cover)),
                            ],
                          ),
                          const SizedBox(height: 10,)
                        ],
                              ...
                              child: TextButton(
                                  ...
                                  onPressed: (){
                                    Navigator.of(context).push(
                                        PageTransition(
                                          child: EditDocAddTimePage(id: widget.id),
