...
import 'Doc_ChangeHoliday_Edit.dart';

class DetailDocChangeHolidayPage extends StatefulWidget {
  final String id;
  const DetailDocChangeHolidayPage({Key? key, required this.id}) : super(key: key);

  @override
  State<DetailDocChangeHolidayPage> createState() => _DetailDocChangeHolidayPageState();
}

class _DetailDocChangeHolidayPageState extends State<DetailDocChangeHolidayPage> {
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: TextButton(
                                  ...
                                  onPressed: (){
                                    Navigator.push(context, MaterialPageRoute(builder: (context) =>  EditDocChangeHolidayPage(id: widget.id,))).then(onGoBack);
                                  },
                                  child: Text('แก้ไข')),
                            ),
                          ),
