...
class DTMDocKaDetailPage extends StatefulWidget {
  final String id;
  const DTMDocKaDetailPage({Key? key, required this.id}) : super(key: key);

  @override
  State<DTMDocKaDetailPage> createState() => _DTMDocKaDetailPageState();
}

class _DTMDocKaDetailPageState extends State<DTMDocKaDetailPage> {
  bool loading = false;
  ...
  Future<Null> getdata() async {
    try{
      ...
      String url = pathurl.dtmKaId+widget.id;
