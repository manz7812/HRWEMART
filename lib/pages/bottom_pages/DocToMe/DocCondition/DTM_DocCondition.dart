...
import 'DTM_DocCondition_Detail.dart';

class DTMDocCondiTionPage extends StatefulWidget {
  const DTMDocCondiTionPage({Key? key}) : super(key: key);

  @override
  State<DTMDocCondiTionPage> createState() => _DTMDocCondiTionPageState();
}

class _DTMDocCondiTionPageState extends State<DTMDocCondiTionPage> {
  ...
  Future<Null> getdata() async {
    try{
      ...
      String url = pathurl.dtmCondition+"?status=$selectedStatus&year=$selectedYear&month=$selectedMonth";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("เอกสารแจ้งเปลี่ยนสภาพ"),
        // leading: IconButton(
        //   onPressed: () {
    ...
    return InkWell(
      onTap: (){
        Navigator.of(context).push(
            PageTransition(
              child: DTMDocConditionDetailPage(id: IDdoc),
