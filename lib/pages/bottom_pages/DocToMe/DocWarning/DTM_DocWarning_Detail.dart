...
class DTMDocWarningDetailPage extends StatefulWidget {
  final String id;
  const DTMDocWarningDetailPage({Key? key, required this.id}) : super(key: key);

  @override
  State<DTMDocWarningDetailPage> createState() => _DTMDocWarningDetailPageState();
}

class _DTMDocWarningDetailPageState extends State<DTMDocWarningDetailPage> {
  bool loading = false;
  ...
  Future<Null> getdata() async {
    try{
      ...
      String url = pathurl.dtmWarningId+widget.id;
