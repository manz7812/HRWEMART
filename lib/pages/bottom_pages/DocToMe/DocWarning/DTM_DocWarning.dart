...
import 'DTM_DocWarning_Detail.dart';

class DTMDocWarningPage extends StatefulWidget {
  const DTMDocWarningPage({Key? key}) : super(key: key);

  @override
  State<DTMDocWarningPage> createState() => _DTMDocWarningPageState();
}

class _DTMDocWarningPageState extends State<DTMDocWarningPage> {
  ...
  Future<Null> getdata() async {
    try{
      ...
      String url = pathurl.dtmWarning+"?status=$selectedStatus&year=$selectedYear&month=$selectedMonth";
  ...
  Future<Null> searchdata(year,month,status) async{
    try{
      ...
      final String url = pathurl.dtmCondition+'?status=$status&year=$year&month=$month';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("เอกสารหนังสือเตือน"),
        // leading: IconButton(
        //   onPressed: () {
    ...
    return InkWell(
      onTap: (){
        Navigator.of(context).push(
            PageTransition(
              child: DTMDocWarningDetailPage(id: IDdoc),
