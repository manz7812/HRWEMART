...
class DTMDocHolidayDetailPage extends StatefulWidget {
  final String id;
  const DTMDocHolidayDetailPage({Key? key, required this.id}) : super(key: key);

  @override
  State<DTMDocHolidayDetailPage> createState() => _DTMDocHolidayDetailPageState();
}

class _DTMDocHolidayDetailPageState extends State<DTMDocHolidayDetailPage> {
  bool loading = false;
  ...
  Future<Null> getdata() async {
    try{
      ...
      String url = pathurl.dtmHolydayId+widget.id;
      ...
      if (response.statusCode == 200) {
        setState(() {
          ...
          dataID = data['data'];
          dataEmp.add(data['data'][0]['rh_emp']);
