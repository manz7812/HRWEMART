...
import 'DTM_DocOT_Detail.dart';

class DTMDocOTPage extends StatefulWidget {
  const DTMDocOTPage({Key? key}) : super(key: key);

  @override
  State<DTMDocOTPage> createState() => _DTMDocOTPageState();
}

class _DTMDocOTPageState extends State<DTMDocOTPage> {
  ...
  Future<Null> getdata() async {
    try{
      ...
      String url = pathurl.dtmOT+"?status=$selectedStatus&year=${selectedYear}&month=$selectedMonth";
  ...
  Future<Null> searchdata(year,month,status) async{
    try{
      ...
      final String url = pathurl.dtmOT+'?status=$status&year=$year&month=$month';
    ...
    return InkWell(
      onTap: (){
        ...
        Navigator.of(context).push(
            PageTransition(
              child: DTMDocOTDetailPage(id: id),
