...
class DTMDocGoodMemoryDetailPage extends StatefulWidget {
  final String id;
  const DTMDocGoodMemoryDetailPage({Key? key, required this.id}) : super(key: key);

  @override
  State<DTMDocGoodMemoryDetailPage> createState() => _DTMDocGoodMemoryDetailPageState();
}

class _DTMDocGoodMemoryDetailPageState extends State<DTMDocGoodMemoryDetailPage> {
  bool loading = false;
  ...
  Future<Null> getdata() async {
    try{
      ...
      String url = pathurl.dtmScoreId+widget.id;
